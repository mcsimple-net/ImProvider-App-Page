...
<body>
    ...
    <section class="hero">
        <h1>Высокоскоростной интернет для дома и бизнеса</h1>
        <p>япровайдер — ваш надежный партнер в мире цифровых технологий. Мы предлагаем широкий спектр услуг связи, от высокоскоростного интернета до цифрового телевидения.</p>
